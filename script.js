...
// Add a new game variable to track the player's lives
let LIVES = 3;

// Add a text object to display the number of remaining lives
let livesText = add([
  text("Lives: "+LIVES),
  pos(10, 21),
  scale(3),
...
// Decrement the lives variable and update the lives text whenever the player collides with a bug
player.onCollide("bug", () => {
  LIVES -= 1;
